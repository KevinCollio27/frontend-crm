...
import type { OrganizationDetail as OrganizationDetailType } from "./data"
      ...
      <header className="flex h-12 shrink-0 items-center justify-between border-b px-4 gap-3">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <div className="flex items-center gap-1 min-w-0 text-sm">
            ...
            <span className="truncate text-xs font-medium">{organization.name}</span>
          </div>
        </div>
        <DropdownMenu>
