...
import type { ContactDetail as ContactDetailType } from "./data"
      ...
      <header className="flex h-12 shrink-0 items-center justify-between border-b px-4 gap-3">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <div className="flex items-center gap-1 min-w-0 text-sm">
            <Link href="/crm/contacts" className="shrink-0 text-xs text-muted-foreground hover:text-foreground transition-colors">
              Contactos
            </Link>
